...
const ProblemSolvingAssessment = () => {
  ...
  const calculateResult = async () => {
    ...
    setAgentStatus("");
    // Route to 'analysis' so Knowledge Gap panel renders; fallback to 'result' if analysis failed
    if (analysisData) {
  ...
  return (
    <div 
      className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans tracking-wide selection:bg-green-500/30"
    >
      ...
      <AnimatePresence>
        {agentStatus && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed top-8 left-1/2 transform -translate-x-1/2 bg-bg-secondary/80 backdrop-blur-xl border border-white/10 px-6 py-3 rounded-full shadow-2xl flex items-center gap-3 z-50 ring-1 ring-white/5"
          >
      ...
      <div className="absolute top-8 left-8 z-50 flex gap-4">
         <button
            ...
            className="group flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-white/5 hover:border-green-500/30 rounded-full backdrop-blur-md text-text-secondary hover:text-green-400 transition-all duration-300 shadow-lg hover:shadow-green-500/10"
         >
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        {currentStep === "intro" && (
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
                <div className="p-8 rounded-2xl border border-border-primary bg-bg-primary hover:border-border-secondary transition-colors">
                    <div className="text-text-muted font-bold mb-4 text-xs uppercase tracking-wider border-b border-border-primary pb-2">Target Skills</div>
                    <div className="flex flex-wrap gap-2">
                      {getCoreSkills().map((skill, i) => (
                          <span key={i} className="px-2 py-1 bg-bg-surface text-slate-300 rounded text-xs font-medium border border-border-secondary">{skill}</span>
                      ))}
                    </div>
                </div>
               
               <div className="p-8 rounded-2xl border border-border-primary bg-bg-primary hover:border-border-secondary transition-colors flex flex-col justify-between">
                  <div className="text-text-muted font-bold mb-2 text-xs uppercase tracking-wider border-b border-border-primary pb-2">Format</div>
                  <div className="text-white text-xl font-medium">Interactive</div>
               </div>
               
               <div className="p-8 rounded-2xl border border-border-primary bg-bg-primary hover:border-border-secondary transition-colors flex flex-col justify-between">
                  <div className="text-text-muted font-bold mb-2 text-xs uppercase tracking-wider border-b border-border-primary pb-2">Analysis</div>
        ...
        {currentStep === "assessment" && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            onClick={(e) => e.stopPropagation()}
            className="w-full max-w-3xl mx-auto bg-bg-primary border border-border-primary p-6 md:p-8 rounded-2xl shadow-xl relative overflow-hidden cursor-default"
          >
             {/* Progress Bar */}
             <div className="absolute top-0 left-0 h-1 bg-bg-surface w-full">
                <motion.div 
                    initial={{ width: 0 }}
            ...
            <div className="flex justify-between items-center mb-6 px-5 py-3 bg-bg-secondary/50 rounded-xl border border-white/5 backdrop-blur-md">
                ...
                <div className="flex items-center gap-6">
                    <div className="text-right">
                         <span className="block text-[8px] font-black text-text-muted uppercase tracking-widest mb-1 leading-none">Time Limit</span>
                    ...
                    <div className="text-left min-w-[80px]">
                         <span className="block text-[8px] font-black text-text-muted uppercase tracking-widest mb-1 leading-none">Progress</span>
                    ...
                    <div className="text-right min-w-[80px]">
                        <span className="block text-[8px] font-black text-text-muted uppercase tracking-widest mb-1 leading-none">Accuracy</span>
                        <div className="flex flex-col gap-1.5 mt-0.5">
                            {(() => {
            ...
            <div className="mb-6 max-h-[140px] overflow-y-auto pr-2 custom-scrollbar border-b border-white/5 pb-4">
              <div className="text-text-muted text-[9px] font-black uppercase tracking-widest mb-2">Challenge</div>
              ...
              {currentQuestion?.type === "coding" ? (
                <div className="space-y-5">
                  <div className="rounded-2xl border border-white/8 bg-slate-950/40 p-4">
                    <p className="text-[10px] font-black uppercase tracking-[0.24em] text-text-muted">Coding Workspace</p>
                    <div className="mt-3 grid gap-4 lg:grid-cols-2">
                      ...
                      <div className="rounded-2xl border border-white/8 bg-[#08101d] p-4">
                        ...
                        <div className="mt-3 grid gap-3">
                          <div>
                            <div className="text-[10px] font-black uppercase tracking-widest text-text-muted">Input</div>
                          ...
                          <div>
                            <div className="text-[10px] font-black uppercase tracking-widest text-text-muted">Output</div>
                  ...
                  {codeEvaluationState[currentQuestion.id] ? (
                    <div className="rounded-2xl border border-white/8 bg-slate-950/40 p-4">
                      <div className="flex items-center justify-between">
                        <p className="text-[10px] font-black uppercase tracking-[0.24em] text-text-muted">Compiler Test Results</p>
                        ...
                        {codeEvaluationState[currentQuestion.id].allResults.map((test, index) => (
                          <div key={`${test.scope}-${index}`} className="rounded-2xl border border-white/8 bg-[#08101d] p-4">
                            <div className="flex items-center justify-between gap-3">
                              <div className="text-xs font-black uppercase tracking-widest text-text-muted">{test.scope} test {index + 1}</div>
                    ...
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-lg border transition-all duration-200 flex items-center gap-3 group relative overflow-hidden h-full min-h-[60px]
                        ${answers[currentQuestionIndex] === option 
                          ...
                          : "bg-transparent border-border-primary text-text-secondary hover:border-slate-600 hover:text-slate-200"}
                        ${(isLocked || isTimedOut) ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
            ...
            {/* Evaluator Feedback Panel — shows after each answer */}
            {currentFeedback && (
              <div className={`mt-4 mb-2 rounded-xl border p-4 text-sm transition-all ${
                currentFeedback.correct
                  ? "bg-green-500/5 border-green-500/20"
                  : "bg-red-500/5 border-red-500/20"
              }`}>
                <div className="flex items-start gap-3">
                  <div className={`text-lg shrink-0 mt-0.5 ${currentFeedback.correct ? "text-green-400" : "text-red-400"}`}>
                    {currentFeedback.correct ? "✔" : "✘"}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      <span className={`text-xs font-black uppercase tracking-widest ${currentFeedback.correct ? "text-green-400" : "text-red-400"}`}>
                        {currentFeedback.correct ? "Correct!" : "Incorrect"}
                      </span>
                      {currentFeedback.mastery && (
                        <span className={`text-[10px] font-mono px-2 py-0.5 rounded-full border ${
                          currentFeedback.mastery.delta >= 0
                            ? "text-green-400 border-green-500/20 bg-green-500/5"
                            : "text-red-400 border-red-500/20 bg-red-500/5"
                        }`}>
                          Mastery {currentFeedback.mastery.delta >= 0 ? "▲" : "▼"} {Math.round(Math.abs(currentFeedback.mastery.delta) * 100)}%
                        </span>
                      )}
                    </div>
                    {currentFeedback.feedback && (
                      <p className="text-slate-300 text-xs leading-relaxed">{currentFeedback.feedback}</p>
                    )}
                    {currentFeedback.explanation && (
                      <p className="text-text-muted text-[11px] mt-1 italic leading-relaxed">
                        💡 {currentFeedback.explanation}
                      </p>
                    )}
                  </div>
            ...
            <div className="flex justify-between items-center pt-8 border-t border-border-primary">
              <button
                ...
                className={`text-text-muted hover:text-white text-sm font-medium px-4 py-2 transition-colors
        ...
        {currentStep === "evaluating" && (
          <div className="text-center py-24 px-8">
             ...
             <p className="text-text-muted text-sm mb-8">Analyzing your thinking steps...</p>
        ...
        {currentStep === "result" && (
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            onClick={(e) => e.stopPropagation()}
            className="w-full max-w-4xl mx-auto bg-bg-primary border border-border-primary p-12 rounded-2xl shadow-xl text-center cursor-default"
          >
             <div className="mb-12">
               <span className="inline-block px-3 py-1 rounded-full bg-bg-surface text-text-secondary text-xs font-bold uppercase tracking-wider mb-4">
                  Assessment Complete
               </span>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8 text-left">
                <div className="bg-bg-secondary/50 p-6 rounded-2xl border border-white/5">
                    <span className="text-text-muted text-[10px] font-bold uppercase tracking-[0.2em] block mb-2">XP EARNED</span>
                    <div className="flex items-baseline gap-2">
                         <span className="text-4xl font-black text-accent-primary">+{xpEarned}</span>
                         <span className="text-xs text-text-muted uppercase font-bold tracking-widest">Points</span>
                    </div>
                </div>

                <div className="bg-bg-secondary/50 p-6 rounded-2xl border border-white/5">
                    <span className="text-text-muted text-[10px] font-bold uppercase tracking-[0.2em] block mb-2">Accuracy Rate</span>
                    <div className="flex items-end gap-2">
                        <span className="text-4xl font-black text-green-400">{Math.round(score)}%</span>
                    </div>
                    <div className="h-1 w-full bg-bg-surface rounded-full mt-3 overflow-hidden">
                        <div className="h-full bg-green-500" style={{ width: `${score}%` }} />
                    </div>
                </div>

                <div className="bg-bg-secondary/50 p-6 rounded-2xl border border-white/5">
                    <span className="text-text-muted text-[10px] font-bold uppercase tracking-[0.2em] block mb-2">current streak</span>
                    <div className="flex items-baseline gap-2">
                        <span className="text-4xl font-black text-amber-500">{streak}</span>
                        <span className="text-xs text-text-muted uppercase font-bold tracking-widest">Days</span>
                    </div>
                </div>
            </div>
            ...
            {interviewFeedback && (
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                className="bg-bg-secondary/40 border border-border-primary rounded-3xl p-8 mb-12 text-left relative overflow-hidden"
              >
              ...
              <div className="mb-12 flex justify-center">
                {badges.map((b, i) => (
                  ...
                  >
                    ...
                    <div className="text-[9px] text-text-muted font-bold uppercase mt-1">{b.desc}</div>
                  </motion.div>
                ))}
              </div>
            )}
            ...
            {analysis?.risk_level && (
                 <div className="grid md:grid-cols-2 gap-6 mb-12 text-left">
                     <div className="bg-bg-secondary/30 p-6 rounded-xl border border-border-primary">
                         <div className="flex items-center justify-between mb-4">
                            <h4 className="text-xs font-bold text-text-muted uppercase tracking-widest">Future Risk Projection</h4>
                     ...
                     <div className="bg-bg-secondary/30 p-6 rounded-xl border border-border-primary">
                         <h4 className="text-xs font-bold text-text-muted uppercase tracking-widest mb-4">Priority Focus Areas</h4>
                         ...
                         <p className="text-text-muted text-xs">These concepts are identified as high-leverage blockers for your growth.</p>
                     </div>
                 </div>
            )}
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-12">
              <button
                ...
                className="px-6 py-3 rounded-xl font-bold text-sm text-text-secondary hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10 transition-colors"
              >
                Back to Dashboard
              </button>
            ...
            <div className="flex justify-center">
                 <button
                       ...
                       className="group text-xs font-bold uppercase tracking-widest text-text-muted hover:text-green-400 transition-colors flex items-center gap-2 py-2"
                    >
          ...
          >
             ...
             <div className="flex items-center justify-between mb-8 pb-6 border-b border-border-primary">
                <div>
                    ...
                    <p className="text-text-secondary text-sm">Detailed breakdown of your cognitive patterns.</p>
                </div>
                <div className="text-right">
                ...
                <div className="md:col-span-2">
                    <div className="bg-bg-secondary/50 border border-border-primary p-6 rounded-xl h-full">
                        <div className="flex items-center gap-2 mb-3">
                             <span className="text-accent-primary bg-blue-500/10 p-1.5 rounded-lg">
                        ...
                        <div className="prose prose-invert prose-sm max-w-none text-slate-300 font-light leading-relaxed mb-6 border-l-2 border-border-secondary pl-4">
                             <p className="text-white font-medium mb-1">"{analysis.gap_analysis.split('.')[0]}."</p>
                             <p className="text-xs text-text-secondary">{analysis.gap_analysis.split('.').slice(1).join('.')}</p>
                        </div>
                            ...
                            <div key={i} className="bg-bg-secondary/30 p-4 border border-border-primary rounded-xl hover:border-border-secondary transition-colors">
                                <div className="flex justify-between items-start mb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-text-muted text-[10px] font-mono border border-border-primary px-1 rounded">Ans: {diag.userAnswer}</span>
                                    </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-4 text-xs bg-black/20 p-3 rounded-lg border border-white/5">
                                    <div>
                                        <span className="text-text-muted font-bold block mb-1">Root Cause</span>
                                        <span className="text-text-secondary leading-relaxed">{diag.root_cause}</span>
                                    </div>
             ...
             <div className="flex justify-end gap-3 pt-4 border-t border-white/5">
                  <button
                    ...
                    className="text-text-secondary hover:text-white text-sm font-medium px-4 py-2 hover:bg-white/5 rounded-lg transition-colors"
                  >
                    Back to Score
                  </button>
                  <button
        ...
        {currentStep === "learning-plan" && (
            <motion.div
             initial={{ opacity: 0, scale: 0.95 }}
             animate={{ opacity: 1, scale: 1 }}
             className="bg-bg-primary border border-border-primary p-8 md:p-12 rounded-2xl shadow-xl text-center max-w-5xl mx-auto overflow-hidden relative"
            >
             {(() => {
                if (!strategy) {
                     return (
                        <div className="flex flex-col items-center justify-center p-20 space-y-6">
                            <div className="relative">
                                <div className="w-12 h-12 border-2 border-border-primary border-t-green-500 rounded-full animate-spin"></div>
                            </div>
                            <p className="text-text-muted font-mono text-xs animate-pulse tracking-widest uppercase">Strategy Agent Architecting Path...</p>
                        </div>
                    );
                }
                ...
                return (
                 <div className="flex flex-col gap-10 text-left w-full">
                   {/* Strategy Overview */}
                   <div className="bg-bg-secondary/50 p-8 rounded-2xl border border-border-primary grid md:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="md:col-span-1 flex flex-col gap-6">
                            ...
                            {analysis?.thinking_pattern && (
                                <div className="bg-bg-surface/50 p-4 rounded-xl border border-border-primary text-center">
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-text-muted block mb-2">Detected Pattern</span>
                                    <span className={`text-sm font-bold ${
                                        analysis.thinking_pattern.includes('Misconception') ? 'text-red-400' : 
                                        analysis.thinking_pattern.includes('Fragile') ? 'text-yellow-400' : 'text-accent-primary'
                                    }`}>
                                        {analysis.thinking_pattern}
                                    </span>
                                </div>
                            ...
                            {strategy.teaching_style && (
                                <div className="bg-bg-surface/50 p-4 rounded-xl border border-border-primary text-center">
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-text-muted block mb-2">Recommended Approach</span>
                        ...
                        {strategy.session_goal && (
                            <div className="mb-8 pb-8 border-b border-border-primary">
                                <div className="flex items-center gap-3 mb-2">
                                     ...
                                     <span className="text-xs font-medium text-text-muted bg-bg-surface px-2 py-0.5 rounded border border-border-secondary">
                                ...
                                <p className="text-text-secondary mt-2 text-sm font-medium">
                                    <span className="text-text-muted">Reinforcing:</span> {strategy.session_goal.secondary_reinforcement}
                                </p>
                            </div>
                        )}
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center bg-bg-surface/30 p-4 rounded-xl border border-border-primary">
                            <span className="text-xs font-bold uppercase tracking-wider text-text-muted shrink-0">Daily Tip</span>
                        ...
                        {strategy.reasoning && (
                            <div className="mt-6 border-t border-border-primary pt-4">
                                 <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-widest text-text-muted">Why this path?</span>
                                 </div>
                                 <p className="text-text-secondary text-sm leading-relaxed pl-4 border-l border-border-secondary py-1 italic">
                                     "{strategy.reasoning}"
                                 </p>
                            </div>
                        )}
                   ...
                   <div className="flex items-center gap-4 py-2 border-b border-border-primary">
                       <h3 className="text-2xl font-bold text-white tracking-tight">Recommended Resources</h3>
                       <span className="bg-bg-surface border border-border-secondary text-xs font-bold px-3 py-1 rounded-full text-text-secondary">
                   ...
                   {strategy.roadmap?.length > 0 && (
                      <div className="grid gap-4 md:grid-cols-3">
                         {strategy.roadmap.map((step, index) => (
                            <div key={`${step.phase}_${index}`} className="rounded-2xl border border-border-primary bg-bg-secondary/50 p-5">
                   ...
                   {group.items.map((resource, index) => (
                      <div key={`${group.category}_${index}`} className="grid md:grid-cols-2 gap-8 items-stretch bg-bg-primary p-6 rounded-2xl border border-border-primary hover:border-border-secondary transition-colors">
                          {/* Resource Card */}
                          <div className="bg-bg-secondary rounded-xl p-6 flex flex-col justify-between h-full border border-border-primary relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-bg-surface text-slate-300 text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-widest border-l border-b border-border-secondary">
                                    {group.category}
                                </div>
                               
                               <div>
                                   <div className="flex justify-between items-center mb-4">
                                        <span className="inline-block px-2 py-1 bg-bg-surface text-text-secondary text-[10px] font-bold uppercase tracking-wider rounded border border-border-secondary">
                                            {resource.platform}
                                        </span>
                                   ...
                                   <p className="text-text-muted mb-6 text-sm leading-relaxed line-clamp-3 font-medium">
                                      ...
                                      <div className="mb-4">
                                          <div className="flex flex-wrap gap-2">
                                              {resource.covered_concepts.map((c, i) => (
                                                  <span key={i} className="px-2 py-1 bg-bg-surface text-text-secondary text-[10px] font-bold rounded border border-border-secondary">
                                                      {c}
                                                  </span>
                                              ))}
                                          </div>
                          ...
                          <div className="flex flex-col h-full gap-4">
                             <div className="bg-bg-secondary rounded-xl p-1 border border-border-primary shadow-sm flex-1 flex flex-col min-h-[200px] relative">
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/40 p-6 text-center">
                                                ...
                                                <p className="text-xs font-bold text-white uppercase tracking-widest mb-1">Interactive Catalog</p>
                                                <p className="text-[10px] text-text-muted leading-relaxed">Direct preview unavailable for this platform. Click 'Start Learning' to view the full resource.</p>
                                            </div>
                                        );
                                    })()}
                                </div>
                             ...
                             <div className="bg-bg-secondary/50 p-5 rounded-xl border border-border-primary">
                   ...
                   {groupedStrategyResources.length === 0 && (
                     <div className="rounded-2xl border border-border-primary bg-bg-secondary/50 p-6 text-sm text-text-secondary">
                   ...
                   <button
                        ...
                        className="self-center mt-12 px-8 py-3 bg-bg-surface hover:bg-slate-700 text-text-secondary hover:text-white rounded-xl font-bold transition-all border border-border-secondary hover:border-slate-600 text-sm"
                    >
                        Return to Dashboard
                   </button>
                 </div>
